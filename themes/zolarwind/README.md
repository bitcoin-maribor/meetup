...
- [Installation](#installation)
  - [Standalone (Quick Start)](#standalone-quick-start)
  - [As a Theme (Integration)](#as-a-theme-integration)
- [Configuration](#configuration)
  - [Basic Configuration](#basic-configuration)
  - [Markdown Highlighting Configuration](#markdown-highlighting-configuration)
...
- [Integrating the theme folder](#integrating-the-theme-folder)
  - [Option 1: Automated Integration (Recommended)](#option-1-automated-integration-recommended)
...
the [Integrating the theme folder](#integrating-the-theme-folder) section for detailed instructions or to use the
automated script.
...
`content/pages/search.md` in the site repository. Theme `content/` is not loaded by Zola (see the [Search](#search)
section).
